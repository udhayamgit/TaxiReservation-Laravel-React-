...
/// Send Message to User for Instant ride details
    ...
    function sendmessage($request_id){
       ...
       $curl = curl_init();
          ...
          CURLOPT_URL => "http://world.msg91.com/api/otp.php?template=&otp_length=&authkey=".$authkey."&message=".$message."&sender=".$sender."&mobile=961".$mobileno."&otp=".$otp."&otp_expiry=&email=",
    ...
    function voicesms($mobileno ,$otp){
          ...
          curl_setopt_array($curl, array(
          CURLOPT_URL => "https://world.msg91.com/apidoc/otp/retry-otp.php?message=".$message."&to=961".$mobileno."&from=319701080068&authkey=".$authkey."",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 30,
