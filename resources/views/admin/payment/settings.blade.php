                ...
                <div class="card card-block card-inverse card-info">
                    <blockquote class="card-blockquote">
                       ...
                       {{-- <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="provider_commission_percentage" class="col-xs-4 col-form-label">@lang('admin.payment.admin_percentage')</label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="number"
                        ...
                        <div class="form-group row">
                            <label for="base_price" class="col-xs-4 col-form-label">@lang('admin.payment.currency')
                                 ( <strong>{{ Setting::get('currency', 'LBP')  }} </strong>)
                            </label>
                            <div class="col-xs-8">
                                <select name="currency" class="form-control" required>
                                    <option @if(Setting::get('currency') == "$") selected @endif value="$">US Dollar (USD)</option>
                                    <option @if(Setting::get('currency') == "LBP") selected @endif value="LBP"> Lebanese Pound (LBP)</option>
                        ...
                        <div class="form-group row">
                            <label for="eta_discount" class="col-xs-4 col-form-label">@lang('admin.payment.eta_discount',['currency' => Setting::get('currency', 'LBP')])</label>
                            <div class="col-xs-8">
                                <input class="form-control"
                                    type="text"
                                    value="{{ Setting::get('eta_discount', '0') }}"
                                    id="eta_discount"
                                    name="eta_discount"
                                    min="0"
                                    placeholder="Eta Discount">
                            </div>
                        </div>
                    </blockquote>
                </div>
