<?php $__env->startSection('title', 'User Reviews '); ?>
    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="mb-1"><?php echo app('translator')->get('admin.review.User_Reviews'); ?></h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="rating-outer">
                                    <input type="hidden" value="<?php echo e($review->user_rating); ?>" name="rating" class="rating"/>
                                </div>
                            </td>
