...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('main/vendor/bootstrap4/bootstrap.min.css')); ?>">
...
<body>
    <div id="form">
        ...
        <script type="text/javascript" src="<?php echo e(asset('main/vendor/jquery/jquery-1.11.3.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('main/vendor/bootstrap4/bootstrap.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('main/assets/js/admin-login.js')); ?>"></script>
