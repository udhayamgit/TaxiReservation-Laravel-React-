...
Route::get('/versions' , 'UserApiController@versions');

Route::post('/login/otp' , 'UserApiController@login_otp');
...
Route::post('user/check/mobile', 'UserApiController@user_check_mobile')->name('user.check.mobile');
Route::post('provider/check/mobile', 'ProviderAuth\TokenController@provider_check_mobile')->name('provider.check.mobile');
...
Route::group(['prefix' => 'provider'], function () {
    ...
    Route::post('/login/otp', 'ProviderAuth\LoginController@login_otp');
...
|--------------------------------------------------------------------------
*/
Route::get('/invoice/{id}', 'ProviderResources\TripController@invoice');
Route::get('/', function () {
    return view('index');
});
...
Route::get('/estimated/fare', 'AdminController@estimated_fare')->name('estimated.fare');
...
Route::get('/rental_package', 'HomeController@rental_package');
...
//CC Avanue
Route::get('/ccavanue' , 'UserApiController@ccavanue_trip');
Route::post('/indipay/ccavanue/web/response' , 'PaymentController@ccavanue_web_response');
Route::post('/indipay/ccavanue/web/cancel/response' , 'PaymentController@ccavanue_web_cancel_response');

// Mobile API

// RSA key generate
Route::post('/rsa/key' , 'PaymentController@rsa_key_generate');

Route::post('/indipay/ccavanue/response' , 'PaymentController@ccavanue_response');
Route::post('/indipay/ccavanue/cancel/response' , 'PaymentController@ccavanue_cancel_response');
